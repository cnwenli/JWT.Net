...
namespace JWT.Net
{
    ...
    public class JWTPackage<T> where T : class
    {
        ...
        /// <param name="encoding"></param>
        /// <returns></returns>
        public static JWTPackage<T> Parse(string token, string password, Encoding encoding)
        {
        ...
        /// <param name="password"></param>
        /// <returns></returns>
        public static JWTPackage<T> Parse(string token, string password)
        {
        ...
        /// <returns></returns>
        public static bool TryParse(string token, string password, out JWTPackage<T> package)
        {
            package = null;
            try
            {
